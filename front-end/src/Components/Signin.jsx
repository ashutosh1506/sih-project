    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      ...
      <div className="bg-white shadow-lg rounded-lg flex w-full max-w-4xl">
        ...
        <div className="w-1/2 bg-cover bg-center p-8 items-center flex justify-center bg-custom-bg3"
             >
            <div className="bg-white w-60 rounded-3xl h-72 shadow-lg text-center" style={{ fontFamily: 'Bruno Ace SC' }}>
        ...
        <div className="bg-pink-50 p-8 rounded shadow-lg w-full max-w-sm">
          <h2 className="text-xl font-semibold text-center mb-4 text-gray-700">First Time User?</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-gray-700 mt-1" style={{ fontFamily: 'Bruno Ace SC' }}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300" style={{ fontFamily: 'Bruno Ace SC' }}>
              Sign Up
            </button>
          </form>
        </div>
