...
const BloodBank = () => {
  ...
  const handleSearch = () => {
    if (bloodGroup && unitsRequired) {
      alert(
        `Searching for Blood Group: ${bloodGroup} and Units: ${unitsRequired}`
      );
    } else {
  ...
  return (
    <>
        ...
        >
          ...
          <div className="absolute top-[120px] left-1/2 transform -translate-x-1/2 w-[80%] max-w-lg  -md p-6 rounded-lg md:w-[60%] lg:w-[50%]">
            ...
            <div className="mb-4 flex items-center whitespace-nowrap">
              <label
                className="font-normal text-[20px] leading-[33.77px] text-left mr-[20px] text-white"
            ...
            <div className="mb-4 flex items-center whitespace-nowrap">
              <label
                className=" font-normal text-white text-[20px]  leading-[33.77px] mr-9"
                style={{ fontFamily: "Bruno Ace" }}
              >
      ...
      >
        <div
          className="absolute inset-0 flex flex-col whitespace-nowrap justify-center text-center text-[26px] font-normal  leading-[38.59px] text-white  w-[500px] h-[29px] mt-[64px] ml-[400px] text-shadow"
          style={{ fontFamily: "Bruno Ace SC", lineHeight: "47.18px" }}
        >
          <p>
            NEAREST AVAILABILITY:{" "}
            <span className="ml-[10px] text-[26px]">HOSPITAL NAME</span>
          </p>
          <p>
            HOSPITAL'S CONTACT NUMBER:{" "}
            <span className="ml-[10px] text-[26px]">123-456-7890</span>
          </p>
        </div>
      </div>
    </>
